 ...
 * Branch_Manager_View_Panel.java
 */
package panels;
...
/**The Branch_Manager_View_Panel displays the view and controls for a Branch Manager User
* extends the javax.swing.JPanel Object
*/
public class Branch_Manager_View_Panel extends javax.swing.JPanel 
{
    /** The Branch_Manager_View_Panel displays the view and controls for a Branch Manager User
    *   extends the javax.swing.JPanel Object
    */
    ...
    */
    public Branch_Manager_View_Panel(User u) 
    {
        user = u;
        ...
        tellerList = dd.getAllTellerInfo(user.getLoc());
        DefaultListModel dl = new DefaultListModel();
        tellerDisplayList.setModel(dl);
        dl.addElement("Teller:          ID:       Location:   Drawer Balance:");
        tellerList.forEach((tellerList1) -> 
        {
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Teller Transaction History:");
        ...
        tellerDisplayList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Teller:          ID:       Location:   Drawer Balance:" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jLabel26.setText("Teller Information:");
        ...
        jTabbedPane1.addTab("Teller Management", jPanel2);
    ...
    */
    private void drawerDepositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drawerDepositButtonActionPerformed
        ...
        PopupManager pm = new PopupManager("");
        pm.displayDrawerDepositPopup(curTeller, user);
        Database_Driver dd = new Database_Driver();
        tellerList = dd.getAllTellerInfo(user.getLoc());
        DefaultListModel dl = new DefaultListModel();
        tellerDisplayList.setModel(dl);
        ...
        {
            User selectedUser = tellerList.get(selectedIndex-1);
            curTeller = selectedUser;
    ...
    */
    private void tellerDisplayListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tellerDisplayListMouseClicked
        ...
        if(tellerDisplayList.getSelectedIndex() != -1 && tellerDisplayList.getSelectedIndex() != 0)
        {
            ...
            User selectedUser = tellerList.get(index-1);
            curTeller = selectedUser;
            selectedUser.getTransactions().stream().map((transaction) -> 
            {
                dl2.addElement(transaction);
